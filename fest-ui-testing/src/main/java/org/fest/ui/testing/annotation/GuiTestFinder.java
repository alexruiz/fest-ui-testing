...
/**
 * Indicates whether a class or method is a GUI test. A GUI test is a class or method annotated with
...
public final class GuiTestFinder {
  ...
  /**
   * Indicates whether the given class and/or method are annotated with <code>{@link GuiTest}</code>. It also searches
   * in super-classes and overridden methods.
   * @param type the class to check.
   * @param method the method to check.
   * @return {@code true} if the given class and/or method are annotated with <code>{@link GuiTest}</code>; 
