...
public class FilePathCreator_deriveFilePathFrom_Test {
  ...
  @Before public void setUp() {
    ...
    pathFactory = new FilePathFactory(fileSeparator("/"));
  }
  ...
  @Test public void should_create_path_for_method_with_no_parameters() throws IOException {
    ...
    String createdPath = pathFactory.deriveFilePathFrom(type, m, parentFolder);
    assertThat(createdPath).isEqualTo("/tmp/org.fest.ui.testing.junit.test.FakeTestClass.noParameters");
  }
  ...
  @Test public void should_create_path_for_method_with_one_parameter() throws IOException {
    ...
    when(parentFolder.getCanonicalPath()).thenReturn("/tmp");
    String createdPath = pathFactory.deriveFilePathFrom(type, m, parentFolder);
    assertThat(createdPath).isEqualTo("/tmp/org.fest.ui.testing.junit.test.FakeTestClass.oneParameter(float)");
  }
  ...
  @Test public void should_create_path_for_method_with_multiple_parameters() throws IOException {
    ...
    when(parentFolder.getCanonicalPath()).thenReturn("/tmp");
    String createdPath = pathFactory.deriveFilePathFrom(type, m, parentFolder);
    assertThat(createdPath).isEqualTo("/tmp/org.fest.ui.testing.junit.test.FakeTestClass.multipleParameters(java.lang.String, int)");
  }
}
